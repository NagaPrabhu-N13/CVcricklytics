...
const faqs = [
  ...
  },
  {
    ...
    answer: `Creativity Ventures IT solution & IT consulting
      ...
      📧 Email: [support_cricklytics@creativityventures.co.in](mailto:support_cricklytics@creativityventures.co.in)
      📞 Phone: +91 7397362027`
  }
];
...
function HeroSection4() {
  ...
  return (
    <div className="w-full h-[100vh] max-h-[100vh] overflow-y-auto flex flex-col items-center px-6 md:px-12 lg:px-24 bg-gradient-to-r from-[#0a1f44] to-[#123456] relative">
      <div className="max-w-7xl w-full mx-auto">
        ...
        <motion.div
          ...
          className="text-center mb-12 sticky top-0 bg-gradient-to-r from-[#0a1f44] to-[#123456] z-10 pt-24 py-4"
        >
          <h1 className="text-4xl md:text-5xl font-bold text-green-400 drop-shadow-lg">
            Cricklytics Subscription Plans
          </h1>
          <p className="mt-4 text-lg text-gray-300">
            Choose the perfect plan to elevate your cricket experience!
          </p>
